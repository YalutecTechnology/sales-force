...
type Envs struct {
	...
	SfcCustomFieldsAccount         map[string]string      `split_words:"true"`
	...
	SfcCustomFieldsToSearchContact map[string]string      `split_words:"true"`
}
