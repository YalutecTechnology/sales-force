...
func (_m *ContextCacheMock) CleanContextToDate(client string, dateTime time.Time) error {
...
func (_m *ContextCacheMock) RetrieveContextFromSet(client string, userID string) []cache.Context {
...
func (_m *ContextCacheMock) StoreContextToSet(_a0 cache.Context) error {
	ret := _m.Called(_a0)
...
// SendTo provides a mock function with given fields: mainSpan, object
...
// SendTo provides a mock function with given fields: mainSpan, state, userID
