...
func TestMain_Main(t *testing.T) {
	...
	os.Setenv("SALESFORCE-INTEGRATION_MESSAGES", `{"waitAgent":"Esperando un agente","WelcomeTemplate":"Hola soy %s y necesito ayuda","Context":"Contexto","DescriptionCase":"Caso levantado por el Bot","UploadImageError":"Imagen no enviada","UploadImageSuccess":"**El usuario adjunto una imagen al caso**","queuePosition":"Posición en la cola","waitTime":"Tiempo de espera"}`)
